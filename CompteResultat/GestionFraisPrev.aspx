<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionFraisPrev.aspx.cs" Inherits="CompteResultat.GestionFraisPrev" EnableViewState="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="float: left; width: 500px;">
        <h1><asp:Literal  ID="Literal9" runat="server">Frais Prevoyance :</asp:Literal> </h1>
        ...
        <div class="RepeaterTP"> 
            ...
            <asp:Repeater ItemType="CompteResultat.DAL.FraisPrevoyance" SelectMethod="GetFP" ID="rptFP" runat="server" OnItemDataBound="rptFP_ItemDataBound">
                <HeaderTemplate>      
                      <table>
                          <tr><th>Annee Survenance</th><th>Type Sinistre</th><th>Frais</th></tr>                    
                </HeaderTemplate>
                <FooterTemplate>
                    </table>                
                </FooterTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width: 300px"><%#: Item.TypeSinistre %></td>
