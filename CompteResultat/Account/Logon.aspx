...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="float:left; margin-top: 10px;">  
        ...
        <asp:Login DestinationPageUrl="~/GestionImport.aspx" ID="LoginUser" UserNameLabelText="Nom d'utilisateur : " PasswordLabelText="Mot de passe : " LabelStyle-CssClass="Label" 
