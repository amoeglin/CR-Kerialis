...
TYPE_CONTROLE = shResultats_AFFICHAGE.Cells(5, 19)
...
If NbAnneeATraiter <> 0 Then ' aucun chargement des données SYNTHESE à faire
    While NbAnneeLue < NbAnneeATraiter
        If shResultats_SYNTHESE.Range(COL_SYNTHESE_GARANTIES & Ligne_SYNTHESE) = Libelle_TOTAL Then
            ...
            Tableau_SYNTHESE(i, 2) = shResultats_SYNTHESE.Range(COL_SYNTHESE_SURVENANCE & Ligne_SYNTHESE) ' année
            Tableau_SYNTHESE(i, 3) = shResultats_SYNTHESE.Range(COL_SYNTHESE_PRESTATIONS & Ligne_SYNTHESE) ' prestations
            Tableau_SYNTHESE(i, 4) = shResultats_SYNTHESE.Range(COL_SYNTHESE_PROVISIONS & Ligne_SYNTHESE) ' provisions
            Tableau_SYNTHESE(i, 5) = shResultats_SYNTHESE.Range(COL_SYNTHESE_COTISATIONS_BRUTES & Ligne_SYNTHESE) ' cotisations brutes
            Tableau_SYNTHESE(i, 6) = shResultats_SYNTHESE.Range(COL_SYNTHESE_CHARGEMENTS & Ligne_SYNTHESE) ' chargements
            Tableau_SYNTHESE(i, 7) = shResultats_SYNTHESE.Range(COL_SYNTHESE_COTISATIONS_NETTES & Ligne_SYNTHESE) ' cotisations nettes
            Tableau_SYNTHESE(i, 8) = shResultats_SYNTHESE.Range(COL_SYNTHESE_RATIO & Ligne_SYNTHESE) ' ratio
            Tableau_SYNTHESE(i, 9) = shResultats_SYNTHESE.Range(COL_SYNTHESE_GAINS_PERTES & Ligne_SYNTHESE) ' gains/pertes
...
If NbAnneeATraiter <> 0 Then ' aucun chargement des données SYNTHESE à faire
    ...
    For AnneeTraitee = AnneeDebutAffichage To AnneeFinAffichage
            ...
            Tableau_SYNTHESE(i, 3) = CumulMontant(shResultats_DATA_CUMUL, Selection_PRESTATIONS, Selection_ANNEE, AnneeTraitee, bTypeCompte) ' prestations
            Tableau_SYNTHESE(i, 4) = CumulMontant(shResultats_DATA_CUMUL, Selection_PROVISIONS, Selection_ANNEE, AnneeTraitee, bTypeCompte) ' provisions
            Tableau_SYNTHESE(i, 5) = CumulMontant(shResultats_DATA_CUMUL, Selection_COTISATIONS_BRUTES, Selection_ANNEE, AnneeTraitee, bTypeCompte) ' cotisations brutes
            Tableau_SYNTHESE(i, 7) = CumulMontant(shResultats_DATA_CUMUL, Selection_COTISATIONS_NETTES, Selection_ANNEE, AnneeTraitee, bTypeCompte) ' cotisations nettes*
            Tableau_SYNTHESE(i, 9) = CumulMontant(shResultats_DATA_CUMUL, Selection_GAINS_PERTES, Selection_ANNEE, AnneeTraitee, bTypeCompte) ' gains/pertes
            Tableau_SYNTHESE(i, 10) = 0 ' écart forcé à 0
            ...
            If Tableau_SYNTHESE(i, 7) <> 0 Then ' ratio
            Tableau_SYNTHESE(i, 8) = (Tableau_SYNTHESE(i, 3) + Tableau_SYNTHESE(i, 4)) / Tableau_SYNTHESE(i, 7) ' ratio
            End If
...
While shResultats_CONTROLE.Range(COL_CONTROLE_SURVENANCE & Ligne_CONTROLE) <> "" And Ligne_CONTROLE < 100
        ...
        Tableau_CONTROLE(i, 2) = shResultats_CONTROLE.Range(COL_CONTROLE_SURVENANCE & Ligne_CONTROLE) ' année
        Tableau_CONTROLE(i, 3) = shResultats_CONTROLE.Range(COL_CONTROLE_PRESTATIONS & Ligne_CONTROLE) ' prestations
        Tableau_CONTROLE(i, 4) = shResultats_CONTROLE.Range(COL_CONTROLE_PROVISIONS & Ligne_CONTROLE) ' provisions
        Tableau_CONTROLE(i, 5) = shResultats_CONTROLE.Range(COL_CONTROLE_COTISATIONS_BRUTES & Ligne_CONTROLE) ' cotisations brutes
        Tableau_CONTROLE(i, 6) = shResultats_CONTROLE.Range(COL_CONTROLE_CHARGEMENTS & Ligne_CONTROLE) ' chargements
        Tableau_CONTROLE(i, 7) = shResultats_CONTROLE.Range(COL_CONTROLE_COTISATIONS_NETTES & Ligne_CONTROLE) ' cotisations nettes
        Tableau_CONTROLE(i, 8) = shResultats_CONTROLE.Range(COL_CONTROLE_RATIO & Ligne_CONTROLE) ' ratio
        Tableau_CONTROLE(i, 9) = shResultats_CONTROLE.Range(COL_CONTROLE_GAINS_PERTES & Ligne_CONTROLE) ' gains/pertes
