...
'******************************
' version v2.5.0 du 23/08/2023   précédente version v2.4.0 du 05/03/2023
'*****************************'
Sub CONTROLE()
...
Case PREV_1AN  ' modèle PREV_1AN
        ...
        Ligne_Depart_SYNTHESE = 15  ' ligne avec l'année
        Ligne_Final_SYNTHESE = 25  ' ligne avec le Total
...
If NbAnneeATraiter <> 0 Then ' aucun chargement des données SYNTHESE à faire
            ...
            Ligne_SYNTHESE = Ligne_Depart_SYNTHESE ' ligne avec l'année
            Tableau_SYNTHESE(i, 2) = shResultats_RESULTATS.Range(COL_SYNTHESE_SURVENANCE & Ligne_Depart_SYNTHESE) ' année
...
'*********  TITRE TABLEAU FRAIS PREVOYANCE ******
