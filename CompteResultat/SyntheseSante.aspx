...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="itemSettings" >
        <h1><asp:Literal  ID="Literal9" runat="server">Synthese Santé :</asp:Literal> </h1> 
    ...
    <div class="itemReports" >
        <h1><asp:Literal  ID="Literal1" runat="server">Rapports santé à générer :</asp:Literal> </h1> 
        ...
        <div>         
            <asp:CheckBox ID="chkGlobalProd" class="element" runat="server" Checked="true" style="display:inline-block;margin-top:0px;" Text="&nbsp;Global société par produit" /><br />
        </div>
        <div>         
         ...
         <div>         
            <asp:CheckBox ID="chk2AnsAllProd" class="element" runat="server" Checked="true" style="display:inline-block;margin-top:00px;" Text="&nbsp;2 ans tous les produits" /><br />
        </div>
         <div>         
