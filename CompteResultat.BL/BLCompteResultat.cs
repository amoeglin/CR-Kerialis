    ...
    public class BLCompteResultat
    {
           ...
           DateTime dateArret, C.eReportTypes reportType, C.eReportTemplateTypes templateType)
        {
            ...
            if (templateType == C.eReportTemplateTypes.SANTE_GLOBAL)
                ExcelSheetHandler.FillGlobalSheet(fiExcelFile, companyList, subsidList, debutPeriod, finPeriod, dateArret, reportType, TaxDef, TaxAct, TaxPer);
            ...
            int yearsToCalc, bool calculateProvision)
        {
            ...
            try
            {
                ...
                ExcelSheetHandler.FillPrevProvSheet(C.ePrevProv.Prev, fiExcelFile, assurNameList, parentCompanyNameList, companyNameList, contrNameList, college, debutPeriod, finPeriod, dateArret, yearsToCalc);

                //Fill the DATA PROV Sheet
                ExcelSheetHandler.FillPrevProvSheet(C.ePrevProv.Prov, fiExcelFile, assurNameList, parentCompanyNameList, companyNameList, contrNameList, college, debutPeriod, finPeriod, dateArret, yearsToCalc);
